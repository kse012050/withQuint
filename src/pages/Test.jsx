...
export default function Test() {
    ...
    const vipSubmit = (e) =>{
        ...
        imgApi('vipProducts/create', vipInputs)
            .then((result)=>{
                console.log(result);
                ...
                <fieldset>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <select name="boardType" onChange={(e)=>selectChange(e, setBoardInputs)}>
                        ...
                        <li>
                            ...
                            <select name="type" onChange={(e)=>selectChange(e, setBoardInputs)}>
